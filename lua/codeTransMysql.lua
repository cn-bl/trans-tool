...
local dbengine = require "luasql.mysql"
...
local dbc = dbengine.mysql()
local db = assert(dbc:connect("dark_text", "dark", "654123", "192.168.31.154"))
...
local function TransOneV2( fpath, regular_jp, t )
	...
	local jp = nil
	local selectdic = {'select * from (select s, zh, v from dic where s in ('}
	...
	selectdic[1+#selectdic] = ') and ((zh is NOT NULL and zh <> \'\') or ( tr is NOT NULL and tr <> \'\'))) b ORDER BY length(b.s) desc;'
	
	insertdic[#insertdic] = '    (' .. jp .. ', \''.. fpath ..'\', \''..time..'\')'
	local language = "s"
	insertdic[1+#insertdic] = onconflict

	-- lfs.mkdir("/Users/cn/bl/dark/tmp-sel-sql")
	-- lfs.mkdir("/Users/cn/bl/dark/tmp-ins-sql")
	--local sql = table.concat( insertdic, "\n")
    --local fti = io.open("/Users/cn/bl/dark/tmp-ins-sql/" .. fpath:gsub("/", "_") .. "-insert.sql", "w")
	...
	local fts = io.open("/Users/cn/bl/dark/tmp-sel-sql/" .. fpath:gsub("/", "_") .. "-select.sql", "w")
	fts:write(sql)
	fts:close()
...
util.GetFiles(
    {
		--  -- client
        -- "dark-client/Assets/Scripts",
        -- "dark-client/Assets/ExternalAssets", -- client
        
        -- "/Users/cn/bl/dark/c/dark-client/Assets/Resources/text/cn",
        -- "/Users/cn/bl/dark/c/dark-client/Assets/workspace/text/cn",
        -- "/Users/cn/bl/dark/c/dark-client/Assets/workspace/ui/help/cn",
		"/Users/cn/bl/dark/c/dark-client/Assets/Scripts"
		
        -- -- server
		-- "/Users/cn/bl/dark/dark-server",
		-- "/Users/cn/dark/server/server-api-grpc-proto/src/main/proto/service",
		
        --"/Users/cn/dark/octo/hilo-octo-server/src",
		-- "/Users/cn/dark/master-data/master"
		--"/Users/cn/dark/master-data/tools",
